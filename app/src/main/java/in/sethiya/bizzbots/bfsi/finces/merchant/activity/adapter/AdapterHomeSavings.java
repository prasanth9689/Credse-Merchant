...
public class AdapterHomeSavings extends RecyclerView.Adapter<AdapterHomeSavings.ViewHolder> {
    ArrayList<Integer> exploreImage;
    ArrayList<String> exploreName;
    Context context;

    public AdapterHomeSavings(Context context, ArrayList<Integer> exploreImg, ArrayList<String> exploreName) {
    ...
    @NonNull
    @Override
    public AdapterHomeSavings.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.model_dash_item_payments, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterHomeSavings.ViewHolder holder, int position) {
