...
public class AdapterHomeInvestments extends RecyclerView.Adapter<AdapterHomeInvestments.ViewHolder> {
    ArrayList<Integer> exploreImage;
    ArrayList<String> exploreName;
    Context context;

    public AdapterHomeInvestments(Context context, ArrayList<Integer> exploreImg, ArrayList<String> exploreName) {
    ...
    @NonNull
    @Override
    public AdapterHomeInvestments.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.model_dash_item_payments, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterHomeInvestments.ViewHolder holder, int position) {
