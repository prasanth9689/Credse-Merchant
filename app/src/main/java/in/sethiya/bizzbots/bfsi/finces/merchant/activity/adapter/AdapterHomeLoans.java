...
public class AdapterHomeLoans extends RecyclerView.Adapter<AdapterHomeLoans.ViewHolder> {
    ArrayList<Integer> exploreImage;
    ArrayList<String> exploreName;
    Context context;

    public AdapterHomeLoans(Context context, ArrayList<Integer> exploreImg, ArrayList<String> exploreName) {
    ...
    @NonNull
    @Override
    public AdapterHomeLoans.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.model_dash_item_payments, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterHomeLoans.ViewHolder holder, int position) {
